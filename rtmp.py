...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 22 21:00:24 2021
...
# receber o argumento de caminho do streaming para o script
...
net = cv2.dnn.readNetFromDarknet(
    ...
    os.path.sep.join([MODEL_BASE_PATH, 'yolov4.weights']))
...
print("[+] Finalizando a recepção do streaming via RTMP...")
vs.stop()
